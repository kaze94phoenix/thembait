	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Membros de Desenvolvimento'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Outras Opcoes</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Novo Membro'), array('action' => 'add'), array('escape' => false)); ?></li>
								</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th>Username<?php //echo $this->Paginator->sort('username'); ?></th>
                                                <th>Especializaco<?php //echo $this->Paginator->sort('username'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($users as $user): ?>
					<tr>
						...
						<td><?php echo h($user['Occupation']['designation']); ?>&nbsp;</td>
