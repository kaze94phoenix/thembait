<div class="projects index">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<p>
				<small><?php echo $this->Paginator->counter(array('format' => __('Pagina {:page} de {:pages}, mostrando {:current} registos de um total de {:count}, comecando no registo {:start}, ending on {:end}')));?></small>
			</p>
